...
char My_ssd1306_WriteChar(uint8_t ch, FontDef Font,uint8_t char_width, SSD1306_COLOR color);
char My_ssd1306_WriteString(uint8_t* str, FontDef Font,const uint8_t* char_width, SSD1306_COLOR color);
